...
import 'takipettikllern_model.dart';
export 'takipettikllern_model.dart';

class TakipettikllernWidget extends StatefulWidget {
  const TakipettikllernWidget({
    super.key,
  ...
  @override
  _TakipettikllernWidgetState createState() => _TakipettikllernWidgetState();
}

class _TakipettikllernWidgetState extends State<TakipettikllernWidget> {
  late TakipettikllernModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TakipettikllernModel());
